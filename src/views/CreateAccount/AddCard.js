...
export default class AddCard extends React.Component {
    ...
    componentDidUpdate(){
        ...
        if(!!addCard.avaible){
            resetAddCard()
            history.pushState(null, '/createAccount/verification')
        }
    }
                ...
                <ul className="list whiteConBox">
                    ...
                    <li>
                        ...
                        <div className="list-info">
                            <input type="text" className="list-info-input" value={this.state.cardNo} maxLength="19" onChange={this.changeCardNo.bind(this)} placeholder="请输入银行卡号"/>
